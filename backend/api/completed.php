<?php
/**
 * DAR Activity Logs - Completed Records API
 *
 * Returns records where work_status = 'finished' and archived_at IS NULL.
 * Admins see all users' completed records; regular users see only their own.
 */
